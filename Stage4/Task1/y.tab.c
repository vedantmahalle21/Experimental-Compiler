...
{
  "$end", "error", "$undefined", "DECL", "ENDDECL", "INT", "STR", "ID",
  "','", "$accept", "Declarations", "DeclList", "Decl", "Type", "VarList", YY_NULLPTR
};
#endif
