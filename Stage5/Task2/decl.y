...
string: STRING                              {}
  ...
  expr  : expr PLUS expr                {$$ = makeOperatorNode("+", $1, $3, 3);}
        ...
        | expr OR expr                  {$$ = makeOperatorNode("O", $1, $3, 6);}
        | expr AND expr                 {$$ = makeOperatorNode("A", $1, $3, 6);}
        ...
        | expr OR var                  {$$ = makeOperatorNode("O", $1, $3, 6);}
        | expr AND var                 {$$ = makeOperatorNode("A", $1, $3, 6);}
        ...
        | var OR expr                  {$$ = makeOperatorNode("O", $1, $3, 6);}
        | var AND expr                 {$$ = makeOperatorNode("A", $1, $3, 6);}
        ...
        | var OR var                  {$$ = makeOperatorNode("O", $1, $3, 6);}
        | var AND var                 {$$ = makeOperatorNode("A", $1, $3, 6);}
        ...
        | ID '(' ArgList ')'            {check($1->Gentry->paramlist, $3);$$ = makeFuncCallNode($1, $3, 13);makeANull();}
        | FIELD                         {}
        ;
